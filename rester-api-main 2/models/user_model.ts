...
const PayoutSchema: Schema = new Schema({
    amount: { type: Number },
    status: { type: String, enum: ['Cancelled', 'Rejected', 'Approved', 'Pending'], default: 'Pending', required: true },
...
const userSchema = new Schema<IUser>({
    ...
    // end  
    gender: { type: String },
    role: { type: String, enum: ["user", "admin", "seller", "supper-admin"], default: 'user', required: true }, // Ensure 'client' and 'affiliate' are in enum
